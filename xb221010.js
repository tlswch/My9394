...
//感谢各位开发者大佬默默付出。不良帅个人整理测试，折腾折腾折腾而已。
{
	"sites": [{
			"key": "csp_XBiu看视界",
			"name": "国内外剧┃视界影视",
	...
	"parses": [{
		...
		},
		{
			...
			"ext": {
				"flag": ["imgo", "qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "mgtv", "芒果", "letv", "乐视", "pptv", "PPTV", "sohu", "bilibili", "哔哩哔哩", "哔哩"],
				"header": {
		...
		},
		{
			...
			"url": "https://dm.xmflv.com:4433/?url=",
			"ext": {
				"flag": ["imgo", "ltnb", "renrenmi", "qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "mgtv", "芒果", "bilibili", "哔哩哔哩", "哔哩"]
			}
		},
		{
			"name": "F3.1",
			"type": 1,
			"url": "http://43.249.192.246:2626/jhy/json.php?token=ktuxzCFGJNPQTWZ569&url=",
			"ext": {
				"flag": ["rx", "ltnb", "renrenmi", "rongxing", "bilibili", "哔哩哔哩", "哔哩", "youku", "优酷", "qiyi", "爱奇艺", "奇艺", "qq", "腾讯", "mgtv", "芒果", "sohu", "搜狐", "letv", "乐视", "xigua", "CL4K", "西瓜"]
			}
		},
		{
			"name": "F3.2",
		...
		},
		{
			"name": "F3.8",
			"type": 1,
			"url": "http://jx.vipmv.co/json.php?token=123457&url=",
			"ext": {
				"flag": ["rx", "ltnb", "renrenmi", "rongxing", "bilibili", "哔哩哔哩", "哔哩", "youku", "优酷", "qiyi", "爱奇艺", "奇艺", "qq", "腾讯", "mgtv", "芒果", "sohu", "搜狐", "letv", "乐视", "xigua", "CL4K", "西瓜"]
			}
		},
		...
		},
		{
			"name": "Q7",
			"type": 0,
			"url": "https://lg.junniu.net/?url="
		},
		{
			"name": "Q8",
			"type": 0,
			"url": "http://player.gaoxin155.com.cn:80/index2022.php?url="
		},
		{
			"name": "Q9",
			"type": 0,
			"url": "http://player.nwctfw.com:80/index2022188.php?url="
		},
		{
			"name": "Q10",
			"type": 0,
			"url": "https://www.jfxz689.com/?url="
		},
		{
			"name": "Q11",
			"type": 0,
		...
		},
		{
			"name": "F6",
			"type": 1,
			"url": "http://api.xiaomaomi.tv/home/api?type=ys&uid=8728968&key=cdkmqvyzFIJPRT2349&url=",
			"ext": {
				"flag": ["qiyi", "iqiyi", "奇艺", "爱奇艺", "qq", "腾讯", "youku", "优酷", "pptv", "PPTV", "letv", "乐视", "bilibili", "哔哩哔哩", "哔哩", "mgtv", "芒果", "xigua", "西瓜", "sohu", "搜狐", "cntv", "cctv", "央视", "1905", "m1905"]
			}
		},
		...
		},
		{
			...
			"ext": {
				"flag": ["imgo", "duoduozy", "renrenmi", "ltnb", "miaoparty", "miaoparty2", "miaoparty3", "laodiyun", "laodim3u8", "lekanzyw", "rx", "CL4K", "fuckapp", "1080P", "wuduzy"]
			}
		},
		{
			"name": "F19",
